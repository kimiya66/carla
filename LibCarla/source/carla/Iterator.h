...
namespace iterator {
  ...
  inline static auto make_map_keys_iterator(It it) {
    ...
    return boost::make_transform_iterator(it, [](const auto &pair) -> ref_to_first { return pair.first; });
  }
  ...
  inline static auto make_map_values_iterator(It it) {
    ...
    return boost::make_transform_iterator(it, [](const auto &pair) -> ref_to_second { return pair.second; });
  }
